    ...
    <section class="kontent">
        <div class="container">
            ...
            <div class="row">
                ...
                <?php $ambil = $koneksi->query("SELECT * FROM produk WHERE ID IN ('133855', '133543','133355','133620'); ");?>
                <?php while ($perproduk= $ambil->fetch_assoc()){ ?>


                <div class="col-md-3">
                    <div class="thumnail">
                        <img src="./img/<?php echo $perproduk ['foto_produk']?>" height="100" weight="80" alt="">
                        <div class="caption">
                            <h3><?php echo $perproduk ['nama_produk']; ?></h3>
                            <h4 class="product-price">Rp. <?php echo number_format($perproduk ['harga_produk']); ?></h4>
                ...
                <div class="row">
                    <div class="col-md-3 col-xs-6">
                        <div class="footer">
                            ...
                            <ul class="footer-links">
                                <li><a href="#"><i class="fa fa-map-marker"></i>R1-R5 2nd floor, Paudra Tower, Central
                                        Atlantis</a></li>
                                <li><a href="#"><i class="fa fa-phone"></i>+021-95-51-84</a></li>
                                <li><a href="#"><i class="fa fa-envelope-o"></i>robostore@gtech.id</a></li>
                            </ul>
                    ...
                    <div class="col-md-3 col-xs-6">
                        <div class="footer">
                            ...
                            <ul class="footer-links">
                                <li><a href="policy.html">Site Policies</a></li>
                                <li><a href="policy.html">Return and Refund Policies</a></li>
                ...
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <span class="copyright">
                            ...
                            Copyright &copy;RoboStore<script>
                            document.write(new Date().getFullYear());
                            </script> All rights reserved | RoboStore is a company under GESANG TECHNOLOGY.corp&trade;
                            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                        </span>
                    </div>
                </div>
