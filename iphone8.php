                ...
                <div class="col-md-5 col-md-push-2">
                    <div id="product-main-img">
                        <div class="product-preview">
                            <img src="./img/iphone8888.jpg" alt="">
                        </div>
                    ...
                    <div id="product-tab">
                        ...
                        <div class="tab-content">
                            ...
                            <div id="tab1" class="tab-pane fade in active">
                                <div class="row">
                                    <div class="col-md-12">
                                        <p> <br> <img src="img/iphone8888.jpg" height="620" width="880">
                                            <br>
                                            <br>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <p>
                                            ...
                                            Weight : 148 grams (5.22 ounces)<br>
                                            Build : Front glass, aluminum body<br>
                                            SIM : Nano-SIM<br>
                                            IP67 dust/water resistant (up to 1m for 30 mins)<br>
                                            Apple Pay (Visa, MasterCard, AMEX certified)
                                            <hr color="#555555" size="4px">
                                            Display : 4.7-inch Retina HD LCD-backlit widescreen <br>
                                            Size : 5.45 x 2.65 x 0.29 inches<br>
                                            Resolution : 1,334 x 750 pixels (326 pixels-per-inch)
                                            <hr color="#555555" size="4px">
